// words.js에서 정답 추첨 함수와 유효성 검사 함수를 가져옴
import { getAnswer, isValidWord } from "./words.js";
// 게임 시도 횟수 6번
...
// 게임 초기화
    ...
    validate(guess) {
        ...
        // 자체 로직 대신 words.js의 검증 함수를 호출하여 중복 완벽 제거
        if (!isValidWord(guess)) return "단어장에 없는 단어입니다.";
